...
//  根据屏幕宽度比例计算宽度
#define SSJ_SCALE_WIDTH(x) ((x) / 375.0) * CGRectGetWidth([UIScreen mainScreen].bounds)
...
//导航栏高度
#define SSJ_NAVIBAR_HEIGHT CGRectGetHeight(self.navigationController.navigationBar.frame)
...
// 是否是主包
#define SSJ_MAIN_PACKAGE [SSJDefaultSource() isEqualToString:@"11505"] || [SSJDefaultSource() isEqualToString:@"11502"]
...
#define SSJ_FONT_SIZE_9 22
#define SSJ_FONT_SIZE_10 10

#pragma mark -
#pragma mark - Iphone
#define SSJ_DEVICE_IS_iPhoneX ([UIScreen instancesRespondToSelector:@selector(currentMode)] ? CGSizeEqualToSize(CGSizeMake(1125, 2436), [[UIScreen mainScreen] currentMode].size) : NO)
