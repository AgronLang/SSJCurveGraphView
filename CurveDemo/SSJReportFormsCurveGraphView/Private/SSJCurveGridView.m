...
@implementation SSJCurveGridView
...
- (void)drawRect:(CGRect)rect {
    ...
    if (_lineStyle == SSJCurveGridViewLineStyleDashed) {
        CGFloat lengths[] = {2, 2};
...
- (void)setLineStyle:(SSJCurveGridViewLineStyle)lineStyle {
